...
namespace CISystem
{
    public partial class SpecialOp: Form
    {
        public SpecialOp()
        {
            InitializeComponent();

            this.Load += new EventHandler(SpecialOp_Load);
        ...
        private void SpecialOp_Load(object sender, EventArgs e)
        {
        ...
        private void assign_Click(object sender, EventArgs e)
        {
            ...
            AssignOfficer Assignform = new AssignOfficer();
        ...
        private void btn_fir_Click_1(object sender, EventArgs e)
        {
            this.Hide();
